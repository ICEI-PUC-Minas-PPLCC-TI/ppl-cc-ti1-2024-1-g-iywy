document.addEventListener("DOMContentLoaded", function () {
    const users = [
        { id: 1, name: "User 1", pricePaid: 0, img: "user1.jpg", products: [] },
        { id: 2, name: "User 2", pricePaid: 0, img: "user2.jpg", products: [] },
        { id: 3, name: "User 3", pricePaid: 0, img: "user3.jpg", products: [] }
    ];
